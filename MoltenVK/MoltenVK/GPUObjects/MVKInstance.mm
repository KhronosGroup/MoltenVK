...
// Add a device extension function that two different extensions both provide, and that is
// therefore available when either of them is enabled.
#define ADD_DVC_EITHER_EXT_ENTRY_POINT(func, EXT, ALT_EXT)  \
	_entryPoints[""#func] = { (PFN_vkVoidFunction)&func, VK_##EXT##_EXTENSION_NAME, nullptr, 0, 0, true, false, VK_##ALT_EXT##_EXTENSION_NAME }

// The alias form of the above, for a function that core promoted under a different name.
#define ADD_DVC_EITHER_EXT_ENTRY_POINT_ALIAS(alias, func, EXT, ALT_EXT)  \
	_entryPoints[""#alias] = { (PFN_vkVoidFunction)&func, VK_##EXT##_EXTENSION_NAME, nullptr, 0, 0, true, false, VK_##ALT_EXT##_EXTENSION_NAME }

// Add both the promoted core function, and the extension function that two extensions provide.
#define ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(func, extSuffix, EXT, ALT_EXT) \
	ADD_DVC_1_3_ENTRY_POINT(func); \
	ADD_DVC_EITHER_EXT_ENTRY_POINT_ALIAS(func##extSuffix, func, EXT, ALT_EXT)
...
#pragma clang diagnostic pop
	...
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdBindVertexBuffers2, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	...
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetCullMode, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetDepthBiasEnable, EXT, EXT_EXTENDED_DYNAMIC_STATE_2, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetDepthBoundsTestEnable, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetDepthCompareOp, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetDepthTestEnable, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetDepthWriteEnable, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_ENTRY_POINT(vkCmdSetEvent2, KHR, KHR_SYNCHRONIZATION_2);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetFrontFace, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetPrimitiveRestartEnable, EXT, EXT_EXTENDED_DYNAMIC_STATE_2, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetPrimitiveTopology, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetRasterizerDiscardEnable, EXT, EXT_EXTENDED_DYNAMIC_STATE_2, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetScissorWithCount, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetStencilOp, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetStencilTestEnable, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	ADD_DVC_1_3_PROMOTED_EITHER_EXT_ENTRY_POINT(vkCmdSetViewportWithCount, EXT, EXT_EXTENDED_DYNAMIC_STATE, EXT_SHADER_OBJECT);
	...
	ADD_DVC_EXT_ENTRY_POINT(vkReleaseSwapchainImagesKHR, KHR_SWAPCHAIN_MAINTENANCE_1);
	...
	ADD_DVC_EXT_ENTRY_POINT(vkCmdDrawMultiEXT, EXT_MULTI_DRAW);
	ADD_DVC_EXT_ENTRY_POINT(vkCmdDrawMultiIndexedEXT, EXT_MULTI_DRAW);
	...
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetLogicOpEXT, EXT_EXTENDED_DYNAMIC_STATE_2, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetPatchControlPointsEXT, EXT_EXTENDED_DYNAMIC_STATE_2, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetAlphaToCoverageEnableEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetAlphaToOneEnableEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetColorBlendAdvancedEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetCoverageModulationModeNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetCoverageModulationTableEnableNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetCoverageModulationTableNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetCoverageReductionModeNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetCoverageToColorEnableNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetCoverageToColorLocationNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetRepresentativeFragmentTestEnableNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetShadingRateImageEnableNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetViewportSwizzleNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetViewportWScalingEnableNV, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EXT_ENTRY_POINT(vkCmdSetColorWriteEnableEXT, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetColorBlendEnableEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetColorBlendEquationEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetColorWriteMaskEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetConservativeRasterizationModeEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetDepthClampEnableEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetDepthClipEnableEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetDepthClipNegativeOneToOneEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetExtraPrimitiveOverestimationSizeEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetLineRasterizationModeEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetLineStippleEnableEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetLogicOpEnableEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EXT_ENTRY_POINT(vkCreateShadersEXT, EXT_SHADER_OBJECT);
	ADD_DVC_EXT_ENTRY_POINT(vkDestroyShaderEXT, EXT_SHADER_OBJECT);
	ADD_DVC_EXT_ENTRY_POINT(vkGetShaderBinaryDataEXT, EXT_SHADER_OBJECT);
	ADD_DVC_EXT_ENTRY_POINT(vkCmdBindShadersEXT, EXT_SHADER_OBJECT);
	ADD_DVC_EXT_ENTRY_POINT(vkCmdSetVertexInputEXT, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetPolygonModeEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetProvokingVertexModeEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetRasterizationSamplesEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetRasterizationStreamEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetSampleLocationsEnableEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetSampleMaskEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
	ADD_DVC_EITHER_EXT_ENTRY_POINT(vkCmdSetTessellationDomainOriginEXT, EXT_EXTENDED_DYNAMIC_STATE_3, EXT_SHADER_OBJECT);
