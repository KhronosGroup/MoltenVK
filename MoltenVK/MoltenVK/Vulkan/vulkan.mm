...
MVK_PUBLIC_VULKAN_SYMBOL void vkCmdDrawMeshTasksIndirectEXT(
	...
	MVKTraceVulkanCallStart();
	MVKAddCmd(DrawMeshTasksIndirect, commandBuffer, buffer, offset, VK_NULL_HANDLE, 0, drawCount, stride);
	MVKTraceVulkanCallEnd();
}
...
MVK_PUBLIC_VULKAN_SYMBOL void vkCmdDrawMeshTasksIndirectCountEXT(
	...
	MVKTraceVulkanCallStart();
	MVKAddCmd(DrawMeshTasksIndirect, commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	MVKTraceVulkanCallEnd();
}
