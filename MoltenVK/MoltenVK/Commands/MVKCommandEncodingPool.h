...
#pragma mark Command resources
	...
	/** returns a MTLComputePipelineState for emulating indirect mesh draw count */
	id<MTLComputePipelineState> getCmdDrawMeshTasksIndirectCountConvertBuffersMTLComputePipelineState();
...
protected:
	...
	id<MTLComputePipelineState> _mtlDrawMeshTasksIndirectCountConvertBuffersComputePipelineState = nil;
