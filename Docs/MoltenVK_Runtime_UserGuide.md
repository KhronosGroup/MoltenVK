...
3. Open the *General* tab and drag either `Package/Latest/static/MoltenVK/MoltenVK.xcframework` or 
    `Package/Latest/dynamic/MoltenVK/MoltenVK.xcframework` to the *Embed Frameworks* (sometimes labeled 
